                    ...
                    <form class="forms-sample" method="POST" action="{{ route('user.profile-update', $user->id) }}" enctype="multipart/form-data">
                        ...
                        @method('put')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="phone" type="number" class="form-control @error('phone') is-invalid @enderror mb-3 text-white" id="Phone" placeholder="Phone" maxlength="10" value="{{ $user->phone }}" required>
                                    @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
